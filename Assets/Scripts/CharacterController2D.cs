...
public class CharacterController2D : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		if (colliderDisableWhenJump != null) {
			colliderDisableWhenJump.isTrigger = m_Rigidbody2D.velocity.y > 0 || colliderDisableThisFrame;
			colliderDisableThisFrame = false;
		}
	}
	...
	public void Move(float move, bool jump)
	{
		...
		if (m_Grounded && jump && m_Rigidbody2D.velocity.y < 0.1)
		{
			...
			if (colliderDisableWhenJump != null)
			{
				colliderDisableWhenJump.isTrigger = true;
				colliderDisableThisFrame = true;
			}
		}
	}
